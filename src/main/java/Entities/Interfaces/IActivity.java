...
public interface IActivity extends DurationAware {
    ...
    /**
     * Returns the Project associated with the current Activity
     *
     * @return the Project associated with the current Activity
     */
    IProject getProject();

    /**
     * Changes the Project associated with the current Activity
     *
     * @param project the new Project to associate with the current Activity
     */
